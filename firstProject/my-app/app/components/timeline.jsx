  ...
  import VerticalTimeline01 from './VerticalTimeline01'
 
  
  function VerticalTimelinePage() {
    ...
    return (
      <>
        <main className="relative h-[600px] flex flex-col justify-center bg-gradient-to-r from-gray-50 to-gray-200 dark:from-gray-800 dark:to-gray-900 overflow-hidden">
