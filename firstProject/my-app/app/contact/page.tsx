const Contact = () => {
  return (
    <>
      <div className="container mx-auto md:px-4 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-2 md:px-4">
          <section className="mb-32">
            <div className="flex justify-center">
              <div className="text-center md:max-w-xl lg:max-w-3xl">
                <h2 className="mt-32 py-6 text-5xl font-bold">Contact us</h2>
              </div>
            </div>
        ...
        <section>
          <h3 className="mt-10 mb-6 text-center text-3xl font-bold text-blue-300">
            Our Location
          </h3>
          <div className="w-full h-96">
            <iframe
              className="w-full h-full rounded-lg"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3068.644215337466!2d-77.03687018461997!3d38.9071929795702!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b7b7d9e5c72b8d%3A0x177c5e1850eb1b79!2sWashington%20DC!5e0!3m2!1sen!2sus!4v1632356105876!5m2!1sen!2sus"
              width="600"
              height="450"
              style={{ border: 0 }}
              allowFullScreen=""
